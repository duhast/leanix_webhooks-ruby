...
# Unit tests for LeanixWebhooksApi::EventResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LeanixWebhooksApi::EventResponse do
  let(:instance) { LeanixWebhooksApi::EventResponse.new }

  describe 'test an instance of EventResponse' do
    it 'should create an instance of EventResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(LeanixWebhooksApi::EventResponse)
    end
  end
